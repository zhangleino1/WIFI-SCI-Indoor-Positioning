...
# Generate regression evaluation plots (scatter with arrows, CDF, histogram)
python visualize_locations.py --model_path ./logs/cnn_lstm/version_X/checkpoints/best_checkpoint.ckpt --model_type cnn_lstm --data_dir ./dataset
